...
struct HomeSearchBar: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> Container {
        ...
        bar.placeholder = String(localized: "搜索视频")
        bar.delegate = context.coordinator
        let field = bar.searchTextField
        field.accessibilityLabel = String(localized: "搜索视频")
    ...
    final class Container: UIView {
        ...
        override init(frame: CGRect) {
            ...
            cancel.accessibilityLabel = String(localized: "收起键盘")
            ...
            delete.accessibilityLabel = String(localized: "清空搜索历史")
